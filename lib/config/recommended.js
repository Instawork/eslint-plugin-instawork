...
var rules = {
  ...
  'import/no-extraneous-dependencies': ['warn', {
    devDependencies: ['**/*.stories.js', '**/*.test.js', '**/stories.js', 'scripts/*', 'scripts/*/*', 'scripts/*/*/*', 'storybook/*', 'test', 'test/*', 'test/**/*']
  }]
};

// "extends" is an existing keyword, and so we use "extend$"
var extend$ = ['airbnb', 'plugin:flowtype/recommended'];

var plugins = ['flowtype'];
